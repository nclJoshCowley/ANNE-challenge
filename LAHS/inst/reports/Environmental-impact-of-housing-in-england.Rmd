...
<!-- Omitted in interest of time & brevity: dblglaz4, loftinsx, watersys -->
...
```{r fig.cap = "Little to no change in heating systems"}
...
```{r, fig.cap = "Newer boiler types being adopted, nationwide"}
...
```{r}
LAHS::tbl1_x_linear_models(fit_sap12, fit_EPceir12e)
```
